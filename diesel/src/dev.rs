...
use crate::models::{Class, Component};
...
pub fn insert_catalog() -> Result<String, String> {
    ...
    populate_classes(&mut classes);

    //Create Components
    let mut components: Vec<Component> = Vec::new();
    populate_components(&mut components);

    //TODO: Decide whether to put the classes into the populate_classes function or otherwise


    Ok("Nice".to_string())
}

fn populate_classes(classes: &mut Vec<Class>) {
...
fn populate_components(comps: &mut Vec<Component>) {
